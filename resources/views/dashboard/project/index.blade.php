                ...
                <div class="card">
                    ...
                    <div class="card-body  border-bottom py-3 d-flex justify-content-between row">
                        <div class="d-flex col-auto  mb-2">
                            <div class="text-muted">
                                ...
                                <div class="mx-2 d-inline-block">
                                    ...
                                    {{ Form::open(['route' => ['projects.index'], 'method' => 'get', 'id' =>
                                    'entry']) }}
                        ...
                        <div class="d-flex col-auto">
                            ...
                            <a href="{{ route('projects.create') }}" class="btn btn-primary h-4 py-3">
                        ...
                        <table class="table card-table table-vcenter text-nowrap datatable" id="users-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ $project->service->ar_title }}
                                    </td>

                                    <td>
                                        {{ $project->client->ar_name }}
                                    </td>

                                    <td class="text-end">

                                        <form class="d-none" id="DELETE_{{ $project->id }}" method="POST"
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="button" data-id="DELETE_{{ $project->id }}"
                    ...
                    <div class="card-footer d-flex align-items-center">
                        {{ $projects->appends(Arr::except(request()->query(),
