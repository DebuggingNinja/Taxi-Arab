                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form accept-charset="utf-8" enctype="multipart/form-data"
                                action="{{ route('dashboard.roles.update',$record->id) }}" method="POST">
                                @method('PATCH')
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                                ...
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col">
                                                        <input type="text" class="form-control"
                                                            value="{{ $record->name }}" name="role_name"
                                                            placeholder="مدير">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        'إدارة الشحن اليدوي'
                                        =>[
                                        'Balance.Charge' => 'شحن يدوي',
                                        'Balance.Review' => 'عرض سجلات الشحن',
                                        ],
                                                        ...
                                                        <div class="col-lg-2 col-md-4 col-6">
                                                            <label class="form-check form-switch">
                                                                <input class="form-check-input" type="checkbox" {{
                                                                    $record->permissions->contains('name', $key) ?
                                                                'checked' : '' }}
                                                                name="{{ $key }}">
