...
class RideDriverRateRequest extends FormRequest
{
        ...
        return [
            ...
            'ride_id' => [
                ...
                function ($attribute, $value, $fail) {
                    ...
                    if (!$ride || $ride->user_id !== user_auth()->id()) {
                        $fail(__('app.The selected ride is not associated with the authenticated user'));
                    }
                },
